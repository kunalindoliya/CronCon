...
<%List<ProfileBean> result=c1.displayProfile(emp_id); 
	 ProfileBean profile=(ProfileBean)result.get(0);
					  %>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title><%=profile.getFirst_name()+" "+profile.getLast_name() %> | CronCon</title>
				...
				<div class="container-fluid">			 
					  <div class="card">
					   ...
					   <%if(profile.getImage()!=null){ %>
						...
						<%} %>
						<a href="updateProfile.jsp?emp_id=<%=emp_id%>" class="btn btn-success btn-block" style="margin-top:5px;"><i class="fa fa-pencil"></i> Edit</a>
					  </div>
