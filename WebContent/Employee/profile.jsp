				...
				<div class="container-fluid">			 
					  <div class="card">
					   ...
					   <%if(profile.getImage()!=null){ %>
						...
						<%} else{ %>
						<img src="https://user.gadjian.com/static/images/personnel_boy.png" class="img-responsive" style="object-fit:cover" width="100%" height="250px">
						<%} %>
            ...
            <div class="card">
              <div class="card-header">
                <ul class="nav nav-pills">
                  <li class="nav-item" style="width:50%" ><a  class="nav-link active li" href="#tab_1" data-toggle="tab">ABOUT</a></li>
                  <li class="nav-item" style="width:50%" ><a  class="nav-link li" href="#tab_2" data-toggle="tab">APPRECIATION</a></li>               
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
                <div class="tab-content">
                   <div class="tab-pane active col-md-7" id="tab_1">
